...
script.createEvent("OnStartEvent").bind(function (eventData) {
    ...
    potWorld.setParent(script.potSelector);
    // potWorld.getTransform().setWorldScale(new vec3(12, 12, 12));
    // potWorld.getTransform().setLocalPosition(new vec3(0, 110, 0));
    // var collider = potWorld.createComponent("Physics.ColliderComponent");
...
//     if (hit) print(hit.collision.getSceneObject().name);
